function [objfc, ndata, objf, objfn] = objf_TetR_experiments_0(paraest, TetRmodel, dataPath, FlPlot, FlMode, PIdx, noise)
...
% - objfn: labels of the objf vectors
    ...
    ParaNames_ParaValues   = get(TetRmodel.parameters, {'Name', 'Value'});
    paraValues = cell2mat((ParaNames_ParaValues(:,2))
