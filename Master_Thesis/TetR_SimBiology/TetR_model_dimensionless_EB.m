...
load('/Users/claudiobroger/Documents/ETH/Master_Thesis/Evolverator/MT_Evolverator/code/DataForEstimation/dataARtet.mat')
...
for kdose=1:length(data.dose)
    d1.Amount = data.dose(kdose)/p11.Value;
