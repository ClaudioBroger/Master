C = linspecer(height(data.dose));
 ...
 for k = 1:height(rand_parameter)
     ...
     %TFlMode = FlMode;
         ...
         %% module 1: ptetTetR + ptetCitrine
             ...
             SimFluoValues1 = simulate_only_SimFluoValues(para,data_IPTG,data,ParaNames,model);
 ...
 %     
         ...
         %% module 1: ptetTetR + ptetCitrine
             ...
             SimFluoValues2 = simulate_only_SimFluoValues(para,data_IPTG,data,ParaNames,model);
             figure(k)
             for a = 1:height(data.dose)
                 subplot(3,1,2)
                 hold on;
         ...
         %% module 1: ptetTetR + ptetCitrine
             ...
             SimFluoValues3 = simulate_only_SimFluoValues(para,data_IPTG,data,ParaNames,model);
