...
rand_parameter.LacIrep = linspace(10, 100, num_draws)';
rand_parameter.LacIrep2 = linspace(0.0001, 1, num_draws)';
rand_parameter.LacIrep3 = linspace(0.0000000001, 0.000001, num_draws)';

save(['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/TetR_Tup1 model/',datestr(now, 'dd-mmm-yyyy'),'_rand_parameter_LacI_TetR_extreme.mat'],'rand_parameter')
