...
p3 = addparameter(LacI_TetRTup1_model, 'kLacTetRTup1', 'Value', 1.3389, 'ValueUnits', '(molarity)/minute');
...
raterule2 = addrule(LacI_TetRTup1_model, 'TetRTup1 = 2*kLacTetRTup1 * (TetRTup1L + (1 - TetRTup1L)/(1 + (LacIfree/(LacIrep+LacIrep2+LacIrep3))^nLacI)) - (dTetRTup1 + mu + degtag) * TetRTup1', 'RuleType', 'rate');
