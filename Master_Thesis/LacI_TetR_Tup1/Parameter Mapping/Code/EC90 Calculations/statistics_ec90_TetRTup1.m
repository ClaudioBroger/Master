...
figure(2)
hold on
title('ANOVA EC90 all Rep - LacI & TetRTup1', 'FontSize',70);
ax = gca;
ax.FontSize = 40;
...
saveas(figure(1), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/Parameter Mapping/EC90 calculations/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_EC90_alltable_TetRTup1', '.jpg']);
saveas(figure(2), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/Parameter Mapping/EC90 calculations/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_EC90_all_TetRTup1', '.jpg']);
close all
...
figure(2)
hold on
title('ANOVA EC90 repression coefficients 1 and 2 - LacI & TetRTup1', 'FontSize',24);
ax = gca;
ax.FontSize = 30;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
set(figure(2), 'Position', get(0, 'Screensize'))
saveas(figure(1), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/Parameter Mapping/EC90 calculations/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_EC90_rep1_rep2_table_TetRTup1', '.jpg']);
saveas(figure(2), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/Parameter Mapping/EC90 calculations/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_EC90_rep1_rep2_TetRTup1', '.jpg']);
close all
...
set(figure(2), 'Position', get(0, 'Screensize'))
saveas(figure(1), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/Parameter Mapping/EC90 calculations/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_EC90_rep1_rep3_table_TetRTup1', '.jpg']);
saveas(figure(2), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/Parameter Mapping/EC90 calculations/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_EC90_rep1_rep3_TetRTup1', '.jpg']);
close all
...
figure(2)
hold on
title('ANOVA EC90 repression coefficients 2 and 3 - LacI & TetRTup1', 'FontSize',24);
ax = gca;
ax.FontSize = 30;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
set(figure(2), 'Position', get(0, 'Screensize'))
saveas(figure(1), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/Parameter Mapping/EC90 calculations/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_EC90_rep2_rep3_table_TetRTup1', '.jpg']);
saveas(figure(2), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/Parameter Mapping/EC90 calculations/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_EC90_rep2_rep3_TetRTup1', '.jpg']);
close all
