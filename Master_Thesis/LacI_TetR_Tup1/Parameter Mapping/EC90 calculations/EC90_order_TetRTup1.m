...
ec90_1over2 = find(ec90_1(:,2) >= ec90_2(:,2));
ec90_2over3 = find(ec90_2(:,2) >= ec90_3(:,2));
ec90_1over3 = find(ec90_1(:,2) >= ec90_3(:,2));
...
rand_parameter_wrong_order = rand_parameter(ec50_1over2,:);

rand_parameter_right_order = rand_parameter;
rand_parameter_right_order(ec50_1over2,:) = [];
