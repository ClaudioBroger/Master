...
load('26-May-2023growth_rates_1_LacI_TetRTup1_t_10000.mat')
load('26-May-2023growth_rates_2_LacI_TetRTup1_t_10000.mat')
load('26-May-2023growth_rates_3_LacI_TetRTup1_t_10000.mat')

load('25-May-2023_rand_parameter_LacI_TetR_PMA1.mat')
...
for k = 1:num_rows
    for dose = 1:height(data_IPTG.dose)
        data_baseline_rep1 = growth_rate_rep1_combined(growth_rate_rep1_combined.Draw == k,:);
        ...
        data_baseline_rep2 = growth_rate_rep2_combined(growth_rate_rep2_combined.Draw == k,:);
        ...
        data_baseline_rep3 = growth_rate_rep3_combined.Draw(growth_rate_rep3_combined.Draw == k,:);
