...
for k = 1:width(growth_rate_aTc_rep1_combined)
    figure(k);
    for a = 1:height(data.dose)
        ...
        plot(time_aTc_rep1_combined{a,k},growth_rate_aTc_rep1_combined{a,k},'-', 'LineWidth', 2, 'DisplayName', strcat('aTc dose: ', num2str(rounded_dose), ' nM'), 'Color', C(a,:));
        
        xlabel('Time', 'FontSize', 30)
        ylabel('Growth rate ','FontSize', 30)
        title('LacI (1st repression coefficient) & TetRTup1 - aTc time dynamics', 'FontSize',40)
...
C = linspecer(height(data.dose));
for k = 1:width(growth_rate_aTc_rep2_combined)
    figure(k);
    for a = 1:height(data.dose)
        hold on;
        ...
        % Convert the rounded value to a string and concatenate with the label
        plot(time_aTc_rep2_combined{a,k},growth_rate_aTc_rep2_combined{a,k},'-', 'LineWidth', 2, 'DisplayName', strcat('aTc dose: ', num2str(rounded_dose), ' nM'), 'Color', C(a,:));
        
        xlabel('Time', 'FontSize', 30)
        ylabel('Growth rate ','FontSize', 30)
        title('LacI (2nd repression coefficient) & TetRTup1 - aTc time dynamics', 'FontSize',40)
    ...
    set(figure(k), 'Position', get(0, 'Screensize'));
    %save figure
    saveas(figure(k), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/PMA1/Plots/Full_aTc/More_time/More_aTc/Corrected/', datestr(now, 'dd-mmm-yyyy-'),num2str(k),'LacI_TetRTup1_PMA1_rep2_aTc_time_dynamics', '.jpg']);

end
close all

%Time dynamics for growth rate over aTc dose Rep 3
C = linspecer(height(data.dose));
for k = 1:width(growth_rate_aTc_rep3_combined)
    figure(k);
    for a = 1:height(data.dose)
        hold on;
        ...
        % Convert the rounded value to a string and concatenate with the label
        plot(time_aTc_rep3_combined{a,k},growth_rate_aTc_rep3_combined{a,k},'-', 'LineWidth', 2, 'DisplayName', strcat('aTc dose: ', num2str(rounded_dose), ' nM'), 'Color', C(a,:));
        
        xlabel('Time', 'FontSize', 18)
        ylabel('Growth rate ','FontSize', 18)
        title('LacI (3rd repression coefficient) & TetRTup1 - aTc time dynamics', 'FontSize',20)
    ...
    set(figure(k), 'Position', get(0, 'Screensize'));
    %save figure
    saveas(figure(k), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/PMA1/Plots/Full_aTc/More_time/More_aTc/Corrected/', datestr(now, 'dd-mmm-yyyy-'),num2str(k),'LacI_TetRTup1_PMA1_rep3_aTc_time_dynamics', '.jpg']);
...
C = linspecer(8);
for k = 1:width(growth_rate_IPTG_rep1_combined)
    figure(k);
%     for a = 1:height(data_IPTG.dose)
    for a = 1:8
        ...
        rounded_dose = round(data_IPTG.dose(35+a) * 100) / 100;

        plot(time_IPTG_rep1_combined{35+a,k},growth_rate_IPTG_rep1_combined{35+a,k},'-', 'LineWidth', 2, 'DisplayName', strcat('IPTG dose: ', num2str(rounded_dose), ' nM'), 'Color', C(a,:));
        
        xlabel('Time', 'FontSize', 50)
        ylabel('Growth rate ','FontSize', 50)
        title('Rep 1 growth over IPTG time dynamics', 'FontSize',60)
...
% Set colorbar ticks and labels
    ...
    cb.TickLabels = {round(data_IPTG.dose(35) * 100) / 100, round(data_IPTG.dose(40) * 100) / 100, round(data_IPTG.dose(45) * 100) / 100};
    cb.FontSize = 25;
    ...
    set(figure(k), 'Position', get(0, 'Screensize'));
    %save figure
    saveas(figure(k), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/PMA1/Plots/Full_aTc/More_time/More_aTc/Corrected/', datestr(now, 'dd-mmm-yyyy-'),num2str(k),'LacI_TetRTup1_PMA1_rep1_IPTG_time_dynamics', '.jpg']);
...
C = linspecer(10);
for k = 1:width(growth_rate_IPTG_rep2_combined)
    figure(k);
    for a = 1:10
        hold on;

        rounded_dose = round(data_IPTG.dose(45+a) * 100) / 100;

        plot(time_IPTG_rep2_combined{45+a,k},growth_rate_IPTG_rep2_combined{45+a,k},'-', 'LineWidth', 2, 'DisplayName', strcat('IPTG dose: ', num2str(rounded_dose), ' nM'), 'Color', C(a,:));
        
        xlabel('Time', 'FontSize', 50)
        ylabel('Growth rate ','FontSize', 50)
        title('Rep 2 growth over IPTG time dynamics', 'FontSize',60)
...
% Set colorbar ticks and labels
    cb.Ticks = [0 0.5 1]; % positions of the midpoints of the color segments
    cb.TickLabels = {round(data_IPTG.dose(45) * 100) / 100, round(data_IPTG.dose(50) * 100) / 100, round(data_IPTG.dose(55) * 100) / 100};
    cb.FontSize = 25;
    ylabel(cb, 'IPTG dose','FontSize', 30)
...
C = linspecer(10);
for k = 1:width(growth_rate_IPTG_rep3_combined)
    figure(k);
    for a = 1:10
        hold on;

        rounded_dose = round(data_IPTG.dose(66+a) * 100) / 100;

        plot(time_IPTG_rep3_combined{66+a,k},growth_rate_IPTG_rep3_combined{66+a,k},'-', 'LineWidth', 2, 'DisplayName', strcat('IPTG dose: ', num2str(rounded_dose), ' nM'), 'Color', C(a,:));
        
        xlabel('Time', 'FontSize', 50)
        ylabel('Growth rate ','FontSize', 50)
        title('Rep 3 growth over IPTG time dynamics', 'FontSize',60)
...
% Set colorbar ticks and labels
    cb.Ticks = [0 0.5 1]; % positions of the midpoints of the color segments
    cb.TickLabels = {round(data_IPTG.dose(66) * 100) / 100, round(data_IPTG.dose(71) * 100) / 100, round(data_IPTG.dose(76) * 100) / 100};
    cb.FontSize = 25;
    ylabel(cb, 'IPTG dose','FontSize', 30)
    set(figure(k), 'Position', get(0, 'Screensize'));
    %save figure
    saveas(figure(k), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI_TetR_Tup1/PMA1/Plots/Full_aTc/More_time/More_aTc/Corrected/', datestr(now, 'dd-mmm-yyyy-'),num2str(k),'LacI_TetRTup1_PMA1_rep3_IPTG_time_dynamics', '.jpg']);
