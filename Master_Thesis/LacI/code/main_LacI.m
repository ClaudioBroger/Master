...
if estimate_parameters
    ...
    [~, ndata, ~, ~] = objf_LacI_experiments_0(p0, model, Settings.model.dataPath, false, Settings.model.FlMode, Settings.model.PIdx, false);
...
if plot_meigo
    [objfc, ndata, objf, objfn] = objf_LacI_experiments_0(paraopt, model, Settings.model.dataPath, true, Settings.model.FlMode, Settings.model.PIdx, false);
end
