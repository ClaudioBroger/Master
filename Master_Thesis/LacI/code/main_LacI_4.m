...
% Step 1: Create model in a seperate model file, run the model & save the
% model using sbiosaveproject
...
ModelSettings_4; % note: you have to fill in the correct model, objF and parameterfiles in this settings file
...
if estimate_parameters
    ...
    [~, ndata, ~, ~] = objf_LacI_experiments_4(p0, model, Settings.model.dataPath, false, Settings.model.FlMode, Settings.model.PIdx, false);
...
if plot_meigo
    [objfc, ndata, objf, objfn] = objf_LacI_experiments_4(paraopt, model, Settings.model.dataPath, true, Settings.model.FlMode, Settings.model.PIdx, false);
end
