...
%Add rate rules
raterule1 = addrule(LacImodel, 'LacI = PAct1_LacI + pt7_LacI + P_4Lacn_LacI*(P_4Lacn_LacI_L + (1- P_4Lacn_LacI_L)/(1 + (LacIfree/LacI_rep)^(nLacI+nLacI_P3)))-(dLacI+dLacI_pt7+mu)*LacI', 'RuleType', 'rate');
