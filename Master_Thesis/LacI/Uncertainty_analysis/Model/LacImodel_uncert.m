...
s2 = addspecies(LacImodel_uncertainty, 'Citrimmature', 'InitialAmount', 0);
...
raterule2 = addrule(LacImodel_uncertainty, 'Citrimmature = kCit * (CitL + (1 - CitL)/(1 + (LacIfree/(LacIrep+LacIrep2+LacIrep3))^nLacI)) - (dCit + mu + kmaturation) * Citrimmature', 'RuleType', 'rate');
