...
figure(2)
hold on
title('ANOVA  slopes around EC90 all Rep - hyperspace', 'FontSize',70);
ax = gca;
ax.FontSize = 40;
...
figure(2)
hold on
title('ANOVA slopes around EC90 repression coefficients 1 and 2 - parameter sets from hyperspace', 'FontSize',24);
ax = gca;
ax.FontSize = 30;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
figure(2)
hold on
title('ANOVA slopes around EC90 repression coefficients 1 and 3 - parameter sets from hyperspace', 'FontSize',24);
ax = gca;
ax.FontSize = 30;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
figure(2)
hold on
title('ANOVA slopes around EC90 repression coefficients 2 and 3 - parameter sets from hyperspace', 'FontSize',24);
ax = gca;
ax.FontSize = 30;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
