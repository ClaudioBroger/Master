...
%Slopes around EC90
for k = 1:length(ec90_1_pesto_ci)
    ...
    [minvalue closest_index] = min(abs(simfluovalue - ec90_1_pesto_ci(k,3)));
...
save(['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO/', datestr(now, 'dd-mmm-yyyy'),'slopes_EC90_1_pesto_ci', '.mat'], 'slopes_ec90_1_pesto');

for k = 1:length(ec90_2_pesto_ci)
    ...
    [minvalue closest_index] = min(abs(simfluovalue - ec90_2_pesto_ci(k,3)));
    lower_fluovalue = simfluovalue(closest_index - 1);
    upper_fluovalue = simfluovalue(closest_index + 1);
    deltafluo = upper_fluovalue - lower_fluovalue;
    lower_dose = doses(closest_index-1);
...
save(['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO/', datestr(now, 'dd-mmm-yyyy'),'slopes_EC90_2_pesto_ci', '.mat'], 'slopes_ec90_2_pesto');

for k = 1:length(ec90_3_pesto_ci)
    ...
    [minvalue closest_index] = min(abs(simfluovalue - ec90_3_pesto_ci(k,3)));
    lower_fluovalue = simfluovalue(closest_index - 1);
    upper_fluovalue = simfluovalue(closest_index + 1);
    deltafluo = upper_fluovalue - lower_fluovalue;
    lower_dose = doses(closest_index-1);
...
save(['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO/', datestr(now, 'dd-mmm-yyyy'),'slopes_EC90_3_pesto_ci', '.mat'], 'slopes_ec90_3_pesto');
...
figure(2)
hold on
title('ANOVA slopes around EC90 all repression coefficients - parameter sets from PESTO CI', 'FontSize',24);
ax = gca;
ax.FontSize = 30;
...
saveas(figure(1), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO CI/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_slopes_EC90_all_table_pesto_CI', '.jpg']);
saveas(figure(2), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO CI/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_slopes_EC90_all_pesto_CI', '.jpg']);
close all
...
figure(2)
hold on
title('ANOVA slopes around EC90 repression coefficients 1 and 2 - parameter sets from PESTO CI', 'FontSize',24);
ax = gca;
ax.FontSize = 30;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
set(figure(2), 'Position', get(0, 'Screensize'))
saveas(figure(1), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO CI/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_slopes_EC90_rep1_rep2_table_pesto_CI', '.jpg']);
saveas(figure(2), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO CI/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_slopes_EC90_rep1_rep2_pesto_CI', '.jpg']);
close all
...
figure(2)
hold on
title('ANOVA slopes around EC90 repression coefficients 1 and 3 - parameter sets from PESTO CI', 'FontSize',24);
ax = gca;
ax.FontSize = 30;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
set(figure(2), 'Position', get(0, 'Screensize'))
saveas(figure(1), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO CI/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_slopes_EC90_rep1_rep3_table_pesto_CI', '.jpg']);
saveas(figure(2), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO CI/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_slopes_EC90_rep1_rep3_pesto_CI', '.jpg']);
close all
...
figure(2)
hold on
title('ANOVA slopes around EC90 repression coefficients 2 and 3 - parameter sets from PESTO CI', 'FontSize',24);
ax = gca;
ax.FontSize = 30;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
set(figure(2), 'Position', get(0, 'Screensize'))
saveas(figure(1), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO CI/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_slopes_EC90_rep2_rep3_table_pesto_CI', '.jpg']);
saveas(figure(2), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO CI/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_slopes_EC90_rep2_rep3_pesto_CI', '.jpg']);
close all
...
saveas(figure(1), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO/', datestr(now, 'dd-mmm-yyyy'),'histograms_slopes_EC90_pesto_ci', '.jpg']);
close all
...
save(['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO/',datestr(now, 'dd-mmm-yyyy'),'_statistics_pesto_ci_slopes_EC90.mat'],'statistics_pesto_slopes_EC90')
