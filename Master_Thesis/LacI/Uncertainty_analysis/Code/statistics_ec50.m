...
figure(2)
hold on
title('ANOVA all repression coefficients - parameter sets from hyperspace', 'FontSize',24);
ax = gca;
ax.FontSize = 20;
...
figure(2)
hold on
title('ANOVA repression coefficients 1 and 2 - parameter sets from hyperspace', 'FontSize',24);
ax = gca;
ax.FontSize = 20;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
figure(2)
hold on
title('ANOVA repression coefficients 2 and 3 - parameter sets from hyperspace', 'FontSize',24);
ax = gca;
ax.FontSize = 20;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
set(figure(2), 'Position', get(0, 'Screensize'))
saveas(figure(1), ['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from Hyperspace/', datestr(now, 'dd-mmm-yyyy'),'ANOVA_EC90_all_table', '.jpg']);
