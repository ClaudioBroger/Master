...
figure(2)
hold on
title('ANOVA repression coefficients 1 and 2 - parameter sets from PESTO CI', 'FontSize',24);
ax = gca;
ax.FontSize = 20;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
figure(2)
hold on
title('ANOVA repression coefficients 1 and 3 - parameter sets from PESTO CI', 'FontSize',24);
ax = gca;
ax.FontSize = 20;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
figure(2)
hold on
title('ANOVA repression coefficients 2 and 3 - parameter sets from PESTO CI', 'FontSize',24);
ax = gca;
ax.FontSize = 20;
lines = findobj(gcf,'Type','Line');
for i = 1:numel(lines)
...
title('EC50 repression coefficient 1 - randomly drawn parameters from PESTO CI')
subplot(1,3,2)
hist_ec50_2_pesto = histogram(ec50_2_pesto(:,2));
title('EC50 repression coefficient 2 - randomly drawn parameters from PESTO CI')
subplot(1,3,3)
hist_ec50_3_pesto = histogram(ec50_3_pesto(:,2));
title('EC50 repression coefficient 3 - randomly drawn parameters from PESTO CI')


statistics_PESTO_CI.sem1 = SEM50_1_pesto;
statistics_PESTO_CI.sem2 = SEM50_2_pesto;
statistics_PESTO_CI.sem3 = SEM50_3_pesto;

statistics_PESTO_CI.tscore1 = ts50_1_pesto;
statistics_PESTO_CI.tscore2 = ts50_2_pesto;
statistics_PESTO_CI.tscore3 = ts50_3_pesto;

statistics_PESTO_CI.CI1 = CI50_1_pesto;
statistics_PESTO_CI.CI2 = CI50_2_pesto;
statistics_PESTO_CI.CI3 = CI50_3_pesto;

statistics_PESTO_CI.std1 = std50_1_pesto;
statistics_PESTO_CI.std2 = std50_2_pesto;
statistics_PESTO_CI.std3 = std50_3_pesto;

statistics_PESTO_CI.interquartile_range1 = r50_1_pesto;
statistics_PESTO_CI.interquartile_range2 = r50_2_pesto;
statistics_PESTO_CI.interquartile_range3 = r50_3_pesto;

statistics_PESTO_CI.mean1 = mean_ec50_1_pesto;
statistics_PESTO_CI.mean2 = mean_ec50_2_pesto;
statistics_PESTO_CI.mean3 = mean_ec50_3_pesto;

statistics_PESTO_CI.var1 = var_ec50_1_pesto;
statistics_PESTO_CI.var2 = var_ec50_2_pesto;
statistics_PESTO_CI.var3 = var_ec50_3_pesto;

statistics_PESTO_CI.ANOVA.all.p = p_50_pesto;
statistics_PESTO_CI.ANOVA.all.tbl = tbl_50_pesto;
statistics_PESTO_CI.ANOVA.all.stats = stats_50_pesto;

statistics_PESTO_CI.ANOVA.rep1_rep3.p = p_50_1_3_pesto;
statistics_PESTO_CI.ANOVA.rep1_rep3.tbl = tbl_50_1_3_pesto;
statistics_PESTO_CI.ANOVA.rep1_rep3.stats = stats_50_1_3_pesto;

statistics_PESTO_CI.ANOVA.rep1_rep2.p = p_50_1_2_pesto;
statistics_PESTO_CI.ANOVA.rep1_rep2.tbl = tbl_50_1_2_pesto;
statistics_PESTO_CI.ANOVA.rep1_rep2.stats = stats_50_1_2_pesto;

statistics_PESTO_CI.ANOVA.rep2_rep3.p = p_50_2_3_pesto;
statistics_PESTO_CI.ANOVA.rep2_rep3.tbl = tbl_50_2_3_pesto;
statistics_PESTO_CI.ANOVA.rep2_rep3.stats = stats_50_2_3_pesto;

statistics_PESTO_CI.CV1 = CV50_1_pesto;
statistics_PESTO_CI.CV2 = CV50_2_pesto;
statistics_PESTO_CI.CV3 = CV50_3_pesto;

save(['/Users/claudiobroger/Documents/ETH/Master/Master_Thesis/LacI/Uncertainty_analysis/Data/Statistics/Parameters from PESTO CI/',datestr(now, 'dd-mmm-yyyy'),'_statistics_PESTO_CI.mat'],'statistics_PESTO_CI')
