...
char *variableFormulas[3] = {
	"piecewiseIQM(3,atcAdded/nMperUnit,ge(time,indTime),0.0);","KdTetR/nMperUnit;","piecewiseIQM(3,TetR/2.0-KdTetR_InUnit/2.0-atc/2.0+pow(pow(KdTetR_InUnit,2.0)+2.0*KdTetR_InUnit*TetR+2.0*KdTetR_InUnit*atc+pow(TetR,2.0)-2.0*TetR*atc+pow(atc,2.0),1.0/2.0)/2.0,ge(TetR,1e-4),0.0)"};
char *reactionNames[6] = {
	"R1","R2","R3","D1","D2","D3"};
char *eventNames[2] = {
	"piecewise_event_2","piecewise_event_1"};
